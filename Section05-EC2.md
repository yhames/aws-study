...
> [AWS - Spot Instances](https://docs.aws.amazon.com/ko_kr/AWSEC2/latest/WindowsGuide/using-spot-instances.html)

스팟 인스턴스는 사용할 인스턴스에 입찰 하는 형식으로 
최대 스팟 가격을 설정하여 해당 가격을 초과하면 2분간 유예기간을 주고 인스턴스를 자동으로 종료합니다.
...
* Spot Instance Request: 
  ...
  * 스팟 인스턴스 요청은 일회성 또는 영구적입니다. 
  * EC2에서는 요청에 연결된 스팟 인스턴스가 중단된 후 스팟 인스턴스 요청을 자동으로 다시 제출합니다.
